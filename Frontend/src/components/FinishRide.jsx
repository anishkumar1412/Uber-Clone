...
<div className="mt-6 w-full flex flex-col justify-center items-center ">
  ...
  <div className='mt-2 flex justify-center items-center  w-screen p-5'>

<Link to='/captain-home'
  onClick={() => {}}
  className="flex justify-center items-center w-full bg-green-600 text-white font-semibold p-2 rounded-lg text-lg "
>
  Finish Ride
</Link>

</div>
<p className='text-red-500 mt-6 text-sm text-center'>Click on finish ride if you have completed the payment</p>
